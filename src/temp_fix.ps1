...
# Update extension.ts
$extensionPath = "c:\Users\ubeyo\OneDrive\Desktop\arcano-vscode-extension\src\extension.ts"
Replace-Line -filePath $extensionPath -lineNumber 7 -newContent "import { ArcanoDebugProvider } from './debugProvider';"

# Create a new debugUI.ts file that doesn't depend on ArcanoDebugHelper
$debugUIContent = @'
...
Set-Content -Path "c:\Users\ubeyo\OneDrive\Desktop\arcano-vscode-extension\src\debugUI.ts" -Value $debugUIContent

# Run TypeScript compiler to verify changes
cd "c:\Users\ubeyo\OneDrive\Desktop\arcano-vscode-extension"
npx tsc
